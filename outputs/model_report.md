...
- `monitor` items: 13,083
- `refresh` items: 8,188
- `refresh_and_review_ctr` items: 6,654
- `refresh_and_review_engagement` items: 1,993
...
|---:|---:|---:|---|---|---:|---:|---|
| 1 | 81.7 | 0.783 | refresh_and_review_ctr | declining_with_demand, low_ctr_visible_page, low_engagement_visible_page, model_decline_risk, visible_model_opportunity, ctr_review_candidate, engagement_review_candidate | 12834 | 66 | down |
| 2 | 81.6 | 0.850 | refresh_and_review_ctr | declining_with_demand, low_ctr_visible_page, model_decline_risk, visible_model_opportunity, ctr_review_candidate | 2498 | 9 | down |
| 3 | 81.5 | 0.789 | refresh_and_review_ctr | declining_with_demand, low_ctr_visible_page, model_decline_risk, visible_model_opportunity, ctr_review_candidate | 8064 | 23 | down |
| 4 | 81.2 | 0.776 | refresh_and_review_ctr | declining_with_demand, low_ctr_visible_page, model_decline_risk, visible_model_opportunity, ctr_review_candidate | 13790 | 27 | down |
| 5 | 81.0 | 0.816 | refresh_and_review_ctr | declining_with_demand, low_ctr_visible_page, model_decline_risk, visible_model_opportunity, ctr_review_candidate | 3393 | 5 | down |
...
| 7 | 80.7 | 0.846 | refresh_and_review_ctr | declining_with_demand, low_ctr_visible_page, model_decline_risk, visible_model_opportunity, ctr_review_candidate | 1622 | 20 | down |
| 8 | 80.4 | 0.827 | refresh | declining_with_demand, model_decline_risk, visible_model_opportunity | 4366 | 8 | down |
| 9 | 80.4 | 0.844 | refresh_and_review_ctr | declining_with_demand, low_ctr_visible_page, model_decline_risk, visible_model_opportunity, ctr_review_candidate | 1597 | 5 | down |
